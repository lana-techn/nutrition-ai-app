 ...
 */
import { analyzeFoodImage as api_ai_analyze_food_image_analyzeFoodImage } from "~backend/ai/analyze_food_image";
import { chatWithNutritionist as api_ai_chat_with_nutritionist_chatWithNutritionist } from "~backend/ai/chat_with_nutritionist";
...
export namespace ai {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.chatWithNutritionist = this.chatWithNutritionist.bind(this)
        }

        /**
         * Analyzes a food image using AI to identify nutritional content.
         */
        public async analyzeFoodImage(params: RequestType<typeof api_ai_analyze_food_image_analyzeFoodImage>): Promise<ResponseType<typeof api_ai_analyze_food_image_analyzeFoodImage>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analyze-image`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_ai_analyze_food_image_analyzeFoodImage>
        }

        /**
         * Provides AI-powered nutrition advice and answers questions.
         */
        public async chatWithNutritionist(params: RequestType<typeof api_ai_chat_with_nutritionist_chatWithNutritionist>): Promise<ResponseType<typeof api_ai_chat_with_nutritionist_chatWithNutritionist>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/chat`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_ai_chat_with_nutritionist_chatWithNutritionist>
        }
    }
}
...
export namespace nutrition {
    ...
    export class ServiceClient {
         ...
         */
        public async getBlogPost(params: { id: number }): Promise<ResponseType<typeof api_nutrition_get_blog_post_getBlogPost>> {
            // Now make the actual call to the API
         ...
         */
        public async getRecommendations(params: RequestType<typeof api_nutrition_get_recommendations_getRecommendations>): Promise<ResponseType<typeof api_nutrition_get_recommendations_getRecommendations>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/recommendations`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_nutrition_get_recommendations_getRecommendations>
        }

        /**
         * Retrieves all published blog posts.
         */
        public async listBlogPosts(): Promise<ResponseType<typeof api_nutrition_list_blog_posts_listBlogPosts>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/blog`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_nutrition_list_blog_posts_listBlogPosts>
        }

        /**
         * Retrieves all food items in the database.
         */
        public async listFoods(): Promise<ResponseType<typeof api_nutrition_list_foods_listFoods>> {
            // Now make the actual call to the API
